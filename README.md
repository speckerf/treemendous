...
[![DOI](https://zenodo.org/badge/502117577.svg)](https://zenodo.org/badge/latestdoi/502117577)
...
The latest version of the reference manual is available [here](treemendous_1.1.1.pdf).
...
Please refer to the documentation for a detailed description of the functions: [treemendous_1.1.1.pdf](treemendous_1.1.1.pdf)
